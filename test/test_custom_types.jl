...
@testset "TypeParameterAccessors, named positions and defaults" begin
  ...
  @test @constinferred(default_type_parameter(MyType, 1)) == :P1
  @test @constinferred(default_type_parameter(MyType, 2)) == :P2
  @test @constinferred(default_type_parameter(MyType{<:Any,2}, 1)) == :P1
  @test @constinferred(default_type_parameter(MyType{<:Any,2}, 2)) == :P2
  ...
  @test @constinferred(type_parameter(MyType{:p1}, p1)) == :p1
  @test @constinferred(type_parameter(MyType{<:Any,:p2}, p2)) == :p2
  @test @constinferred(default_type_parameter(MyType, p1)) == :P1
  @test @constinferred(default_type_parameter(MyType, p2)) == :P2
end
